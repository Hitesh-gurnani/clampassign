...
import { toggleMenu,closeMenu, toggleMenuLearn, handleMenuandScanner, selectedWalletDetails } from './connectWalletSlice'
...
<div className= 'animate-trans-top fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center'>
        ...
        <h5 class=" m-auto mb-3 ml-15 text-base text-center font-bold text-gray-900 md:text-xl">
            Connect wallet
            
        </h5>
        <AiOutlineCloseCircle className='h-7 w-7 cursor-pointer ' onClick={()=>dispatch(closeMenu())} />
        </div>
        
        <ul class="my-4 space-y-2">
        <p class="text-sm text-gray-500 font-bold dark:text-gray-400">Recommended</p>
            <li>
                <div onClick={()=>dispatch(selectedWalletDetails("MetaMask"))}>
                    
                <a href="#" class="flex items-center p-1 text-base font-bold text-gray-900 rounded-lg  hover:bg-gray-100 group hover:shadow  dark:hover:0 " >
            ...
            <li onClick={()=>dispatch(selectedWalletDetails("Coinbase Wallet"))}>
                <a href="#" class="flex items-center p-1 text-base font-bold text-gray-900 rounded-lg  hover:bg-gray-100 group hover:shadow  dark:hover:0 ">
            ...
            <li onClick={()=>dispatch(selectedWalletDetails("Opera Wallet"))}>
                <a href="#" class="flex items-center p-1 text-base font-bold text-gray-900 rounded-lg  hover:bg-gray-100 group hover:shadow  dark:hover:0 ">
            ...
            <li onClick={()=>dispatch(selectedWalletDetails("Wallet Connect"))}>
                <a href="#" class="flex items-center p-1 text-base font-bold text-gray-900 rounded-lg  hover:bg-gray-100 group hover:shadow  dark:hover:0 ">
        ...
        <div className='flex justify-between'>
            <a href="#" class="inline-flex items-center text-xs font-normal text-gray-500 hover:underline dark:text-gray-400">
                New to Ethereum wallets?</a>
                <div className='font-bold text-sm cursor-pointer' onClick={()=>{dispatch(toggleMenuLearn())}}>Learn more</div>
        </div>
    </div>
